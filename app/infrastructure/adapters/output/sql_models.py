...
class SQLFarm(Base):
    ...
    # ✅ CAMBIAR: usar minúsculas y guión bajo
    image_url = Column(String(500), nullable=False, default="assets/img/default_farm.png")
    latitude = Column(Float, nullable=False, default=0.0)
    longitude = Column(Float, nullable=False, default=0.0)
    altitude = Column(Integer, nullable=False, default=0)
    establishment_year = Column(Integer, nullable=True)
    main_variety = Column(String(100), nullable=True)
